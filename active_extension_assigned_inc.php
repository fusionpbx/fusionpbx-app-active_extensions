			...
			if ($extension == $user_row['user']) {
				...
				if ($number == $extension) {
					if ($application == "conference") {
						$alt_color = "background-image: url('".PROJECT_PATH."/themes/".$settings->get('domain', 'template', 'default')."/images/background_cell_active.gif";
					}
					switch ($application) {
					case "conference":
						$style_alternate = "style=\"color: #444444; background-image: url('".PROJECT_PATH."/themes/".$settings->get('domain', 'template', 'default')."/images/background_cell_conference.gif');\"";
						break;
					case "fifo":
						$style_alternate = "style=\"color: #444444; background-image: url('".PROJECT_PATH."/themes/".$settings->get('domain', 'template', 'default')."/images/background_cell_fifo.gif');\"";
						break;
					case "valet_park":
						$style_alternate = "style=\"color: #444444; background-image: url('".PROJECT_PATH."/themes/".$settings->get('domain', 'template', 'default')."/images/background_cell_fifo.gif');\"";
						break;
					default:
						$style_alternate = "style=\"color: #444444; background-image: url('".PROJECT_PATH."/themes/".$settings->get('domain', 'template', 'default')."/images/background_cell_active.gif');\"";
					}
					echo "<tr>\n";
					...
					echo "<td valign='top' class='".$row_style[$c]."' $style_alternate>\n";
						...
						//record start/stop 
							$tmp_file = $settings->get('switch', 'recordings', '')."/archive/".date("Y")."/".date("M")."/".date("d")."/".$uuid.".mp3";
					...
					$style_alternate = "style=\"color: #444444; background-image: url('".PROJECT_PATH."/themes/".$settings->get('domain', 'template', 'default')."/images/background_cell_light.gif');\"";
					echo "<tr>\n";
